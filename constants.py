...
# Оптимизированная система из 10 рангов (геймификация)
TITLES = [
    ...
    {"name": "⚜️ Эксперт Торговли", "min_deals": 100, "min_rating": 4.5},
    {"name": "🔥 Про-Трейдер", "min_deals": 50, "min_rating": 4.0},
    {"name": "🛡️ Проверенный", "min_deals": 25, "min_rating": 4.2},
    {"name": "⚔️ Старший Трейдер", "min_deals": 15, "min_rating": 4.3},
